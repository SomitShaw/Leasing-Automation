		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "DocumentExtractorApp",
									"targetURL": "#documentinfoextractor-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"documentinfoextractor-display": {
								"semanticObject": "documentinfoextractor",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=documentinfoextractor",
									"url": sap.ui.require.toUrl("documentinfoextractor")
								}
							}
						}
					}
